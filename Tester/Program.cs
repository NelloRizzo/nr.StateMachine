...
namespace Tester
{
    class Program
    {
        ...
        class DigitEvent : MachineEvent
        {
            public char Digit { get; set; }
            public DigitEvent() : base() { Name = "digit"; }
        }

        class OperationEvent : MachineEvent
        {
            public char Operation { get; set; }
        ...
        {
            var wf = new Machine<Calculator>();

            var stateDisplay = new MachineState<Calculator>() { Name = "display" };
            stateDisplay.Transitions.Add(new Transition<Calculator>()
            {
                Action = (c, e) =>
                {
